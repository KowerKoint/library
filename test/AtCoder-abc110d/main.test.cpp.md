...
data:
  ...
  bundledCode: "#line 1 \"test/AtCoder-abc110d/main.test.cpp\"\n#define PROBLEM \"\
    https://atcoder.jp/contests/abc110/tasks/abc110_d\"\n#line 2 \"base.hpp\"\n\n\
    ...
    }\n#line 3 \"test/AtCoder-abc110d/main.test.cpp\"\n\n/* #include <atcoder/all>\
    ...
    \      return res;\n    }\n};\n#line 9 \"test/AtCoder-abc110d/main.test.cpp\"\n\
    \nvoid solve(){\n    ll n, m; cin >> n >> m;\n    auto fact = prime_factor(m);\n\
    \    Counting<MI7> counting;\n    MI7 ans = 1;\n    for(auto [key, val] : fact)\
    \ ans *= counting.combination(val+n-1, val);\n    print(ans);\n}\n\n// generated\
  ...
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc110/tasks/abc110_d\"\n#include\
    ...
    \ \"counting.hpp\"\n\nvoid solve(){\n    ll n, m; cin >> n >> m;\n    auto fact\
    \ = prime_factor(m);\n    Counting<MI7> counting;\n    MI7 ans = 1;\n    for(auto\
    \ [key, val] : fact) ans *= counting.combination(val+n-1, val);\n    print(ans);\n\
  ...
  verifiedWith: []
documentation_of: test/AtCoder-abc110d/main.test.cpp
layout: document
redirect_from:
- /verify/test/AtCoder-abc110d/main.test.cpp
- /verify/test/AtCoder-abc110d/main.test.cpp.html
