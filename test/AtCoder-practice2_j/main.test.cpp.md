...
data:
  ...
  bundledCode: "#line 1 \"test/AtCoder-practice2_j/main.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/practice2/tasks/practice2_j\"\n#line 2 \"base.hpp\"\
    ...
    \      return res;\n    }\n};\n#line 3 \"test/AtCoder-practice2_j/main.test.cpp\"\
    ...
    \ internal_operator::zero<T>>;\n#line 8 \"test/AtCoder-practice2_j/main.test.cpp\"\
    \n\nvoid solve(){\n    int n, q; cin >>  n>> q;\n    VL a(n); cin >> a;\n    RMaxQ<ll>\
    \ rmq(a);\n    REP(_, q) {\n        ll t, l, r; cin >> t >> l >> r;\n        if(t\
    \ == 1) {\n            l--;\n            rmq.set(l, r);\n        } else if(t ==\
    \ 2) {\n            l--;\n            print(rmq.prod(l, r));\n        } else {\n\
    \            l--;\n            print(rmq.max_right(l, [&](ll x) { return x < r;\
  ...
  verifiedWith: []
documentation_of: test/AtCoder-practice2_j/main.test.cpp
layout: document
redirect_from:
- /verify/test/AtCoder-practice2_j/main.test.cpp
- /verify/test/AtCoder-practice2_j/main.test.cpp.html
