...
data:
  ...
  code: "#include \"KowerKoint/base.hpp\"\n\n/* #include <atcoder/all> */\n/* using\
    ...
    \ s;\n    int n = s.length();\n    VI dp(n+1, INF);\n    VI len(n+1);\n    FOR(i,\
    \ 1, n+1) len[i] = to_string(i).length();\n    dp[0] = 0;\n    REP(i, n) {\n \
  ...
  verifiedWith: []
documentation_of: test/Codeforces-ecr25-f/main.cpp
layout: document
redirect_from:
- /library/test/Codeforces-ecr25-f/main.cpp
- /library/test/Codeforces-ecr25-f/main.cpp.html
