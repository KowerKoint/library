...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/391
    links:
    - https://github.com/online-judge-tools/template-generator)
    - https://yukicoder.me/problems/no/391
  bundledCode: "#line 1 \"test/yukicoder-391/main.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/391\"\
    ...
    }\n#line 3 \"test/yukicoder-391/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    \      return res;\n    }\n};\n#line 9 \"test/yukicoder-391/main.test.cpp\"\n\n\
    void solve(){\n    ll n, m; cin >> n >> m;\n    if(n < m) {\n        print(0);\n\
    \        return;\n    }\n    Counting<MI7> counting;\n    counting.expand(m);\n\
    \    print(counting.stirling(n, m) * counting.fact[m]);\n}\n\n// generated by\
    \ oj-template v4.7.2 (https://github.com/online-judge-tools/template-generator)\n\
    int main() {\n    // Fasterize input/output script\n    ios::sync_with_stdio(false);\n\
    \    cin.tie(nullptr);\n    cout << fixed << setprecision(100);\n    // scanf/printf\
    \ user should delete this fasterize input/output script\n\n    int t = 1;\n  \
    \  //cin >> t; // comment out if solving multi testcase\n    for(int testCase\
    \ = 1;testCase <= t;++testCase){\n        solve();\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/391\"\n#include \"base.hpp\"\
    \n\n/* #include <atcoder/all> */\n/* using namespace atcoder; */\n/* #include\
  ...
  verifiedWith: []
documentation_of: test/yukicoder-391/main.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder-391/main.test.cpp
- /verify/test/yukicoder-391/main.test.cpp.html
