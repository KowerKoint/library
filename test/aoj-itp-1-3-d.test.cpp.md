...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-itp-1-3-d.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_3_D\"\
    ...
    \n\nint main() {\n    int a, b, c; cin >> a >> b >> c;\n    Prime pm;\n    auto\
    \ divisors = pm.divisor(c);\n    print(upper_bound(ALL(divisors), b) - lower_bound(ALL(divisors),\
    \ a));\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_3_D\"\
    \n#include \"integer/prime.hpp\"\n\nint main() {\n    int a, b, c; cin >> a >>\
    \ b >> c;\n    Prime pm;\n    auto divisors = pm.divisor(c);\n    print(upper_bound(ALL(divisors),\
    \ b) - lower_bound(ALL(divisors), a));\n}\n"
  dependsOn:
  - integer/prime.hpp
...
layout: document
redirect_from:
- /verify/test/aoj-itp-1-3-d.test.cpp
- /verify/test/aoj-itp-1-3-d.test.cpp.html
