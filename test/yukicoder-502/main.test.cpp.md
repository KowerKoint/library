...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder-502/main.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/502\"\
    ...
    }\n#line 3 \"test/yukicoder-502/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    #line 8 \"test/yukicoder-502/main.test.cpp\"\n\nvoid solve(){\n    ll n, k; cin\
    \ >> n >> k;\n    auto [fact, ifact] = MI7::factorial(n+k);\n}\n\n// generated\
  ...
  verifiedWith: []
documentation_of: test/yukicoder-502/main.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder-502/main.test.cpp
- /verify/test/yukicoder-502/main.test.cpp.html
