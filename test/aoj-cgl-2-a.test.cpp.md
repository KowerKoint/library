...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-cgl-2-a.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_A\"\
    ...
    \ Points) {\n        return sqrt(dist2(Points));\n    }\n};\n#line 4 \"test/aoj-cgl-2-a.test.cpp\"\
    \nint main() {\n    int q; cin >> q;\n    while(q--) {\n        Point<int> p0,\
    \ p1, p2, p3; cin >> p0 >> p1 >> p2 >> p3;\n        Line<int> l0(p0, p1), l1(p2,\
    \ p3);\n        if(l0.parallel(l1)) {\n            cout << 2 << endl;\n      \
  ...
  verifiedWith: []
documentation_of: test/aoj-cgl-2-a.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-cgl-2-a.test.cpp
- /verify/test/aoj-cgl-2-a.test.cpp.html
