...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo-montmort-number.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/montmort_number_mod\"\n#line 2 \"base.hpp\"\
    ...
    using VV7 = Vector<V7>;\nusing VVV7 = Vector<VV7>;\n#line 4 \"test/yosupo-montmort-number.test.cpp\"\
    \n\nll m;\nll mod() {\n    return m;\n}\n\nint main() {\n    ll n; cin >> n >>\
    \ m;\n    auto res = montmort<Modint<mod>>(n);\n    print(Vector<Modint<mod>>(res.begin()+1,\
    \ res.end()));\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo-montmort-number.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo-montmort-number.test.cpp
- /verify/test/yosupo-montmort-number.test.cpp.html
