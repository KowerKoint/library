...
data:
  ...
  bundledCode: "#line 1 \"test/AOJ-DPL_5_D/main.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_D\"\
    ...
    }\n#line 3 \"test/AOJ-DPL_5_D/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    \      return res;\n    }\n};\n#line 9 \"test/AOJ-DPL_5_D/main.test.cpp\"\n\n\
    void solve(){\n    ll n, k; cin >> n >> k;\n    print(Counting<MI7>().combination(n+k-1,\
  ...
  verifiedWith: []
documentation_of: test/AOJ-DPL_5_D/main.test.cpp
layout: document
redirect_from:
- /verify/test/AOJ-DPL_5_D/main.test.cpp
- /verify/test/AOJ-DPL_5_D/main.test.cpp.html
