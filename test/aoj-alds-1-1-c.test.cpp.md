...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-alds-1-1-c.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_1_C\"\
    ...
    \ + sz*(i+2));\n        }\n        return res;\n    }\n};\n#line 3 \"test/aoj-alds-1-1-c.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/aoj-alds-1-1-c.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-alds-1-1-c.test.cpp
- /verify/test/aoj-alds-1-1-c.test.cpp.html
