...
data:
  ...
  bundledCode: "#line 1 \"test/yukicoder-430/main.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/430\"\
    ...
    }\n#line 3 \"test/yukicoder-430/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    \        return res;\n    }\n};\n#line 8 \"test/yukicoder-430/main.test.cpp\"\n\
    \nvoid solve(){\n    string s; cin >> s;\n    int m; cin >> m;\n    ll ans = 0;\n\
    \    Trie<char, 'A'> trie;\n    REP(i, m) {\n        string c; cin >> c;\n   \
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/430\"\n#include \"base.hpp\"\
    ...
    \ 'A'> trie;\n    REP(i, m) {\n        string c; cin >> c;\n        trie.add(c);\n\
    \    }\n    trie.build_failure();\n    print(trie.aho_corasick(s));\n}\n\n// generated\
    \ by oj-template v4.7.2 (https://github.com/online-judge-tools/template-generator)\n\
    int main() {\n    // Fasterize input/output script\n    ios::sync_with_stdio(false);\n\
    \    cin.tie(nullptr);\n    cout << fixed << setprecision(100);\n    // scanf/printf\
    \ user should delete this fasterize input/output script\n\n    int t = 1;\n  \
    \  //cin >> t; // comment out if solving multi testcase\n    for(int testCase\
  ...
  verifiedWith: []
documentation_of: test/yukicoder-430/main.test.cpp
layout: document
redirect_from:
- /verify/test/yukicoder-430/main.test.cpp
- /verify/test/yukicoder-430/main.test.cpp.html
