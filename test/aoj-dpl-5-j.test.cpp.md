...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_J
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_J
  bundledCode: "#line 1 \"test/aoj-dpl-5-j.test.cpp\"\n#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_J\"\
    \n#line 2 \"base.hpp\"\n\n#include <bits/stdc++.h>\nusing namespace std;\n\n#line\
    ...
    \ static T& addassign(T& l, const T& r) {\n        return l += r;\n    }\n   \
    ...
    using VV7 = Vector<V7>;\nusing VVV7 = Vector<VV7>;\n#line 4 \"test/aoj-dpl-5-j.test.cpp\"\
    \n\nint main() {\n    int n, k; cin >> n >> k;\n    print(Counting<MI7>{}.partition_table(n,\
    \ k)[n][k]);\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_5_J\"\
  ...
  verifiedWith: []
documentation_of: test/aoj-dpl-5-j.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-dpl-5-j.test.cpp
- /verify/test/aoj-dpl-5-j.test.cpp.html
