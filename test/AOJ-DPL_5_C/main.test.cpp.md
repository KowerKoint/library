...
data:
  ...
  bundledCode: "#line 1 \"test/AOJ-DPL_5_C/main.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_C\"\
    ...
    }\n#line 3 \"test/AOJ-DPL_5_C/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    \      return res;\n    }\n};\n#line 9 \"test/AOJ-DPL_5_C/main.test.cpp\"\n\n\
    void solve(){\n    ll n, k; cin >> n >> k;\n    Counting<MI7> counting(k);\n \
    \   print(n < k? 0 : counting.stirling(n, k) * counting.fact[k]);\n}\n\n// generated\
  ...
  verifiedWith: []
documentation_of: test/AOJ-DPL_5_C/main.test.cpp
layout: document
redirect_from:
- /verify/test/AOJ-DPL_5_C/main.test.cpp
- /verify/test/AOJ-DPL_5_C/main.test.cpp.html
