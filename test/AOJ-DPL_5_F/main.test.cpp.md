...
data:
  ...
  bundledCode: "#line 1 \"test/AOJ-DPL_5_F/main.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_F\"\
    ...
    }\n#line 3 \"test/AOJ-DPL_5_F/main.test.cpp\"\n\n/* #include <atcoder/all> */\n\
    ...
    \      return res;\n    }\n};\n#line 9 \"test/AOJ-DPL_5_F/main.test.cpp\"\n\n\
    void solve(){\n    ll n, k; cin >> n >> k;\n    print(n < k? 0 : Counting<MI7>().combination(n-1,\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/DPL_5_F\"\n#include\
    ...
    /* #include \"expansion/ac-library/all.hpp\" */\n#include \"modint.hpp\"\n#include\
    \ \"counting.hpp\"\n\nvoid solve(){\n    ll n, k; cin >> n >> k;\n    print(n\
    \ < k? 0 : Counting<MI7>().combination(n-1, k-1));\n}\n\n// generated by oj-template\
  ...
  verifiedWith: []
documentation_of: test/AOJ-DPL_5_F/main.test.cpp
layout: document
redirect_from:
- /verify/test/AOJ-DPL_5_F/main.test.cpp
- /verify/test/AOJ-DPL_5_F/main.test.cpp.html
