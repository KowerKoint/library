...
data:
  ...
  bundledCode: "#line 1 \"test/AOJ-ALDS_1_1_C/main.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/ALDS1_1_C\"\n#line 2 \"base.hpp\"\n\n\
    ...
    }\n#line 3 \"test/AOJ-ALDS_1_1_C/main.test.cpp\"\n\n/* #include <atcoder/all>\
    ...
    \ = 1;\n    while(n) {\n        if(n & 1) {\n            res *= a;\n         \
    \   res %= m;\n        }\n        n >>= 1;\n        a *= a;\n        a %= m;\n\
    \    }\n    return res;\n}\n\n#line 8 \"test/AOJ-ALDS_1_1_C/main.test.cpp\"\n\n\
    void solve(){\n    int n; cin >> n;\n    int ans = 0;\n    Prime pn;\n    REP(i,\
  ...
  verifiedWith: []
documentation_of: test/AOJ-ALDS_1_1_C/main.test.cpp
layout: document
redirect_from:
- /verify/test/AOJ-ALDS_1_1_C/main.test.cpp
- /verify/test/AOJ-ALDS_1_1_C/main.test.cpp.html
